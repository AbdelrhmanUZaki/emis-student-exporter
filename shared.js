...
// ---------- sorting ----------
// boys-first / girls-first: grade -> gender group -> class -> name (alphabetical).
// alpha: grade -> name only (alphabetical, boys and girls mixed, no class grouping).
...
function buildXlsx(rows, refYear) {
  ...
  const app = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties"><Application>StudentDataExporter v3.5</Application></Properties>';
